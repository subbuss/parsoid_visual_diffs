...
Util.computeOpts = function(argv) {
	...
	if (!opts.html1.baseHref) {
		opts.html1.baseHref = opts.html1.server + opts.title;
	}
	...
	if (!opts.html2.baseHref) {
		opts.html2.baseHref = opts.html2.server + opts.wiki + '/' + opts.title;
	}
	if (!opts.html1.hasOwnProperty('injectJQuery')) {
		opts.html1.injectJQuery = true; // Parsoid output does not load jquery
	}
