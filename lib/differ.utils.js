...
Util.computeOpts = function(opts) {
	...
	opts.phpScreenShot = opts.outdir + encodeURIComponent(opts.prefix) + ".php.png";
	opts.psdScreenShot = opts.outdir + encodeURIComponent(opts.prefix) + ".parsoid.png";
	opts.diffFile = opts.outdir + encodeURIComponent(opts.prefix) + ".diff.png";
